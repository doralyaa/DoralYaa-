...
const products = [
    ...
    { id: 5, restaurantId: 4, category: 'food', name: { es: "Capuchino", en: "Cappuccino" }, price: 8050, image: "capuchino.png", popular: true, optionGroups: [{ name: { es: "Temperatura", en: "Temperature" }, options: ["Caliente", "Frío"] }, { name: { es: "Tamaño", en: "Size" }, options: ["7 onzas ($ 8.500)", "9 onzas ($ 10.500)", "12 onzas ($ 13.500)", "14 onzas ($ 16.000)", "16 onzas ($ 18.400)"] }] },
    ...
    { id: 18, restaurantId: 5, category: 'food', name: { es: "Arepa del Pueblo", en: "Arepa del Pueblo" }, description: { es: "Pollo, hogao, maicitos, cebolla grillé, maduritos y salsa dulce maíz", en: "Chicken, hogao, sweet corn, grilled onion, sweet plantain and sweet corn sauce" }, price: 15000, image: "grill_pueblo.jpeg", popular: true },
    ...
    { id: 21, restaurantId: 5, category: 'food', name: { es: "Arepaburger", en: "Arepaburger" }, description: { es: "Carne de hamburguesa, jamón, tocineta y queso tipo mozzarella", en: "Burger meat, ham, bacon and mozzarella cheese" }, price: 22200, image: "grill_aburger.jpg", popular: false },
    { id: 22, restaurantId: 5, category: 'food', name: { es: "Combinada", en: "Combined Arepa" }, description: { es: "Queso tipo mozzarella, carne de res, pollo, hogao", en: "Mozzarella cheese, beef, chicken, hogao" }, price: 22800, image: "grill_combinada.jpg", popular: false },
    { id: 23, restaurantId: 5, category: 'food', name: { es: "Pollo y Champiñones", en: "Chicken & Mushrooms" }, description: { es: "Queso tipo mozzarella, pollo, champiñones y tocineta", en: "Mozzarella cheese, chicken, mushrooms and bacon" }, price: 19800, image: "grill_pollocham.jpg", popular: false },
    { id: 24, restaurantId: 5, category: 'food', name: { es: "Doña Lucía", en: "Doña Lucía" }, description: { es: "Jamón, queso tipo mozzarella, carne de cerdo, cebolla y maicitos", en: "Ham, mozzarella cheese, pork, onion and sweet corn" }, price: 21000, image: "grill_doña.jpg", popular: false },
    { id: 25, restaurantId: 5, category: 'food', name: { es: "Mexicana", en: "Mexican Arepa" }, description: { es: "Frijol refrito, guacamole, carne de res, pico de gallo y picante", en: "Refried beans, guacamole, beef, pico de gallo and spicy sauce" }, price: 26400, image: "grill_mexicana.jpg", popular: false },
    { id: 26, restaurantId: 5, category: 'food', name: { es: "Antioqueña", en: "Antioqueña" }, description: { es: "Queso tipo mozzarella, frijol refrito, guacamole, carne, hogao, chorizo, maduro y aguacate", en: "Mozzarella cheese, refried beans, guacamole, meat, hogao, chorizo, sweet plantain and avocado" }, price: 28800, image: "grill_antioqueña.jpeg", popular: false },
    { id: 27, restaurantId: 5, category: 'food', name: { es: "Super Arepa", en: "Super Arepa" }, description: { es: "Pollo, carne, chicharrón, maicitos, tocineta, hogao, salsa BBQ y queso tipo mozzarella", en: "Chicken, meat, pork rinds, sweet corn, bacon, hogao, BBQ sauce and mozzarella cheese" }, price: 34800, image: "grill_super.jpg", popular: true },
    ...
    { id: 40, restaurantId: 1, category: 'food', name: { es: "Entrada - Patacones con Hogao", en: "Appetizer - Patacones with Hogao" }, price: 14400, image: "cat_food.png", popular: false },
    { id: 41, restaurantId: 1, category: 'food', name: { es: "Hamburguesa Artesanal Santa María Clásica", en: "Santa María Classic Artisan Burger" }, description: { es: "Carne artesanal de 150 gramos de res con tocineta, pan, quesillo, tocineta, cebolla caramelizada, tomate y lechuga.", en: "150g artisan beef patty with bacon, bread, regional cheese, caramelized onion, tomato and lettuce." }, price: 27600, image: "cat_food.png", popular: true },
    { id: 42, restaurantId: 1, category: 'food', name: { es: "Hamburguesa Artesanal Dulce espera", en: "Dulce espera Artisan Burger" }, description: { es: "Carne artesanal de 150 gramos de res con tocineta rellena de quesillo, Pan, quesillo, tocineta, cebolla caramelizada, tomate y lechuga.", en: "150g artisan beef patty with bacon stuffed with cheese, Bread, cheese, bacon, caramelized onion, tomato and lettuce." }, price: 28800, image: "cat_food.png", popular: false },
    { id: 43, restaurantId: 1, category: 'food', name: { es: "Hamburguesa Artesanal Pulled Pork", en: "Pulled Pork Artisan Burger" }, description: { es: "Carne artesanal de 150 gramos de res, 100 gramos de pulled pork, pan, quesillo de la región, tocineta, cebolla caramelizada, tomate y lechuga y 100 gramos papas a la francesa", en: "150g artisan beef patty, 100g pulled pork, bread, regional cheese, bacon, caramelized onion, tomato, lettuce and 100g french fries." }, price: 32400, image: "cat_food.png", popular: false },
    { id: 44, restaurantId: 1, category: 'food', name: { es: "Porción papas a la francesa", en: "French Fries Portion" }, price: 6000, image: "cat_food.png", popular: false },
    { id: 45, restaurantId: 1, category: 'food', name: { es: "Salchipapas", en: "Salchipapas" }, description: { es: "Papas fritas, salchicha, huevos codorniz, quesillo de la región, y salsas", en: "French fries, sausage, quail eggs, regional cheese, and sauces." }, price: 21600, image: "cat_food.png", popular: false },
    { id: 46, restaurantId: 1, category: 'food', name: { es: "Alitas de pollo", en: "Chicken Wings" }, description: { es: "Alas de pollo en salsa BBQ, acompañadas con papas a la francesa", en: "Chicken wings in BBQ sauce, accompanied with french fries." }, price: 26400, image: "cat_food.png", popular: false },
    { id: 47, restaurantId: 1, category: 'food', name: { es: "Ceviche de Chicharrón", en: "Pork Rind Ceviche" }, description: { es: "Cama de guacamole, con 250 gramos de chicharrón carnudo, salsa acevichada, tres patacones y limón.", en: "Guacamole bed, with 250g meaty pork rind, acevichada sauce, three patacones and lemon." }, price: 30000, image: "cat_food.png", popular: false },
    { id: 48, restaurantId: 1, category: 'food', name: { es: "Costillas en salsa BBQ", en: "BBQ Ribs" }, description: { es: "300 gramos de Costilla de cerdo bañada en Salsa BBQ de la casa, papas a la francesa, y ensalada.", en: "300g Pork ribs bathed in house BBQ sauce, french fries, and salad." }, price: 46800, image: "cat_food.png", popular: true },
    { id: 49, restaurantId: 1, category: 'food', name: { es: "Punta de Anca", en: "Punta de Anca (Sirloin)" }, description: { es: "250 gramos de punta de anca, acompañada de papas a la francesa, chimichurri y ensalada.", en: "250g sirloin, accompanied with french fries, chimichurri and salad." }, price: 46800, image: "cat_food.png", popular: false },
    { id: 50, restaurantId: 1, category: 'food', name: { es: "Churrasco", en: "Churrasco (Steak)" }, description: { es: "250 gramos de Churrasco, acompañada de papas a la francesa, chimichurri y ensalada.", en: "250g Steak, accompanied with french fries, chimichurri and salad." }, price: 46800, image: "cat_food.png", popular: false },
    { id: 51, restaurantId: 1, category: 'food', name: { es: "Pechuga a la Plancha", en: "Grilled Chicken Breast" }, description: { es: "Acompañada papas a la francesa y ensalada", en: "Accompanied with french fries and salad." }, price: 36000, image: "cat_food.png", popular: false }
];
...
function openOptionsModal(productId, qty) {
    ...
    if (product.optionGroups && product.optionGroups.length > 0) {
        ...
        product.optionGroups.forEach((group, gIdx) => {
            ...
            const isSize = groupName.toLowerCase() === "tamaño" || groupName.toLowerCase() === "size";

            let wrapperStyle = "display: flex; flex-direction: column; gap: 8px;";
            if (isHorizontal) {
                wrapperStyle = "display: flex; flex-direction: row; gap: 24px; flex-wrap: wrap;";
            } else if (isSize) {
                wrapperStyle = "display: grid; grid-template-columns: 1fr 1fr; gap: 8px;";
            }
...
function addItemToCart(product, qty, option) {
    ...
    if (option) {
        // Detectar reemplazo de precio total, ej: "($ 10.350)"
        if (option.includes('($')) {
            const fullPriceMatches = [...option.matchAll(/\(\$ ([\d.]+)\)/g)];
            if (fullPriceMatches.length > 0) {
                const match = fullPriceMatches[0];
                const valStr = match[1].replace(/\./g, '');
                const val = parseInt(valStr);
                if (!isNaN(val)) finalPrice = val;
            }
        }

        // Detectar ajustes de precio de suma, ej: "(+ $7.000)"
        if (option.includes('(+ $')) {
            const addMatches = [...option.matchAll(/\(\+ \$([\d.]+)\)/g)];
